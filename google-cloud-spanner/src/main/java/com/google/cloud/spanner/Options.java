...
public final class Options implements Serializable {
  ...
  /**
   * Specifying this will cause the transaction to be committed when executing the DML statement. A
   * requirement is that the transaction should have a single action which is a DML statement. This
   * option is automatically specified if Connection.isAutocommit() is true.
   */
  public static InlineCommitOption inlineCommitOption() {
    return INLINE_COMMIT_OPTION;
  }
